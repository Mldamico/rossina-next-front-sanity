...
export type Conjunto = {
  ...
  _key?: Maybe<Scalars['String']>;
  _type?: Maybe<Scalars['String']>;
  /** Precio de la prenda en conjunto y el tipo de conjunto */
  conjunto?: Maybe<Scalars['String']>;
  /** Precio del producto */
  precio?: Maybe<Scalars['Float']>;
};

export type ConjuntoFilter = {
  _key?: Maybe<StringFilter>;
  _type?: Maybe<StringFilter>;
  conjunto?: Maybe<StringFilter>;
  precio?: Maybe<FloatFilter>;
};

export type ConjuntoSorting = {
  _key?: Maybe<SortOrder>;
  _type?: Maybe<SortOrder>;
  conjunto?: Maybe<SortOrder>;
...
export type Producto = Document & {
  ...
  /** Segundo tipo del producto */
  tipoOpcional?: Maybe<Scalars['String']>;
  ...
  disponible?: Maybe<Scalars['Boolean']>;
  colores?: Maybe<Array<Maybe<Scalars['String']>>>;
  conjunto?: Maybe<Array<Maybe<Conjunto>>>;
  talles?: Maybe<Array<Maybe<Scalars['String']>>>;
};
...
export type ProductoFilter = {
  ...
  articulo?: Maybe<StringFilter>;
  marca?: Maybe<StringFilter>;
  tipo?: Maybe<StringFilter>;
  tipoOpcional?: Maybe<StringFilter>;
  mainImage?: Maybe<ImageFilter>;
  precio?: Maybe<FloatFilter>;
  descripcion?: Maybe<StringFilter>;
  disponible?: Maybe<BooleanFilter>;
};

export type ProductoSorting = {
  _id?: Maybe<SortOrder>;
  _type?: Maybe<SortOrder>;
  _createdAt?: Maybe<SortOrder>;
  _updatedAt?: Maybe<SortOrder>;
  ...
  articulo?: Maybe<SortOrder>;
  marca?: Maybe<SortOrder>;
  tipo?: Maybe<SortOrder>;
  tipoOpcional?: Maybe<SortOrder>;
  mainImage?: Maybe<ImageSorting>;
  precio?: Maybe<SortOrder>;
  descripcion?: Maybe<SortOrder>;
  disponible?: Maybe<SortOrder>;
};
...
export type RootQueryProductoArgs = {
  id: Scalars['ID'];
};
...
export type RootQueryAllProductoArgs = {
  where?: Maybe<ProductoFilter>;
  sort?: Maybe<Array<ProductoSorting>>;
...
export type AllProductoQueryVariables = Exact<{
  tipo?: Maybe<Scalars['String']>;
...
export type AllProductoQuery = (
  { __typename?: 'RootQuery' }
  & { productos: Array<(
    { __typename?: 'Producto' }
    & Pick<Producto, '_id' | 'nombre' | 'articulo' | 'tipo' | 'descripcion' | 'marca' | 'tipoOpcional' | 'precio' | 'disponible' | 'colores' | 'talles'>
    & { slug?: Maybe<(
      { __typename?: 'Slug' }
      & Pick<Slug, 'current'>
    ...
    )>>>, conjunto?: Maybe<Array<Maybe<(
      { __typename?: 'Conjunto' }
      & Pick<Conjunto, 'conjunto' | 'precio'>
    )>>>, mainImage?: Maybe<(
      { __typename?: 'Image' }
      & { asset?: Maybe<(
        { __typename?: 'SanityImageAsset' }
